...
const VIDEOS = [
  {
    src: '/Assets/video_4.mp4',
    labelFr: 'La Miraculeuse Transformation',
    labelAr: 'معجزة التحول',
    labelEn: 'The Miraculous Transformation',
    descFr: 'Cas réel traité à la Clinique Zekri',
    descAr: 'حالة حقيقية علاجها في عيادة زكري',
    descEn: 'A real case treated at Zekri Dental Clinic',
  },
  {
    src: '/Assets/video_1.mp4',
    labelFr: 'Évolution Dentaire en Algérie',
    labelAr: 'تطور طب الأسنان في الجزائر',
    labelEn: 'Dental Evolution in Algeria',
    descFr: 'Découvrez le progrès dentaire en Algérie',
    descAr: 'شاهد تطور طب الأسنان بالجزائر',
    descEn: 'Witness the evolution of dentistry in Algeria',
  },
  {
    src: '/Assets/video_3.mp4',
    labelFr: 'Plus Grande Clinique d\'Algérie',
    labelAr: 'أكبر عيادة أسنان في الجزائر',
    labelEn: 'Algeria\'s Largest Dental Clinic',
    descFr: 'L\'innovation dentaire redéfinie',
    descAr: 'حيث تُصمَّم الابتسامات على الشخصية',
    descEn: 'Where smiles are designed for your personality',
  },
  {
    src: '/Assets/video_turkey.mp4',
    labelFr: 'Accueil VIP à la Clinique Zekri',
    labelAr: 'عيادة زكري ترحب بضيوفها',
    labelEn: 'Zekri Clinic Welcomes You',
    descFr: 'Une expérience dentaire unique à Blida',
    descAr: 'تجربة علاجية فريدة في البليدة',
    descEn: 'A unique dental experience in Blida',
  },
];
